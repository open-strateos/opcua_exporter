...
package openapi
// SensorAlerts Alert settings
type SensorAlerts struct {
	Humidity SensorAlertsHumidity `json:"humidity,omitempty"`
	Temperature SensorAlertsTemperature `json:"temperature,omitempty"`
}
